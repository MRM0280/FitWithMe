      ...
      bottomNavigationBar: Material(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              bottomBarItem(1, 'assets/icon/1.png', 'assets/icon/1_active.png'),
              bottomBarItem(2, 'assets/icon/5.png', 'assets/icon/5_active.png'),
              bottomBarItem(3, 'assets/icon/2.png', 'assets/icon/2_active.png'),
              bottomBarItem(4, 'assets/icon/3.png', 'assets/icon/3_active.png'),
              bottomBarItem(5, 'assets/icon/4.png', 'assets/icon/4_active.png'),
            ],
          ),
        ),
      ),
